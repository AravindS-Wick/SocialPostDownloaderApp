...
[Edit this page](https://github.com/expo/expo/edit/main/docs/pages/develop/development-builds/introduction.mdx)
...
Difference between Expo Go and development builds [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#difference-between-expo-go-and-development-builds)
...
Native app and JavaScript bundle [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#native-app-and-javascript-bundle)
...
Use libraries with native code that aren't in Expo Go [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#use-libraries-with-native-code-that-arent)

Consider [`react-native-webview`](https://docs.expo.dev/versions/latest/sdk/webview) as an example, a library that contains native code, but [is included in Expo Go](https://github.com/expo/expo/blob/main/apps/expo-go/package.json#L23). When you run `npx expo install react-native-webview` command in your project, it will install the library in your node\_modules directory, which includes both the JS code and the native code. But the JS bundle you are building _only_ uses the JS code. Then, your JS bundle gets uploaded to Expo Go, and it interacts with the native code that was already bundled with the app.
...
Test changes in app icon, name, splash screen [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#test-changes-in-app-icon-name-splash)
...
Remote push notifications [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#remote-push-notifications)
...
Implementing App/Universal links [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#implementing-appuniversal-links)
...
Open projects using older SDKs (iOS device only) [Permalink](https://docs.expo.dev/develop/development-builds/introduction/#open-projects-using-older-sdks-ios-device)
