...
Build on EAS [Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#build-on-eas)
...
Build locally using the EAS CLI [Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#build-locally-using-the-eas-cli)
...
Build locally without EAS [Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#build-locally-without-eas)
...
Are you using this library in a existing (bare) React Native apps? [Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#are-you-using-this-library-in-a)
...
[Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#prerequisites)
...
An [Android Emulator](https://docs.expo.dev/workflow/android-studio-emulator) is optional if you want to test your
app on an emulator.
...
[Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#prerequisites-1)
...
[Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#prerequisites-2)
...
Simulator](https://docs.expo.dev/workflow/ios-simulator) installed.
...
[Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#prerequisites-3)
...
[Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#prerequisites-4)
...
credentials](https://docs.expo.dev/app-signing/managed-credentials#generating-app-signing-credentials) so the app
...
[Permalink](https://docs.expo.dev/develop/development-builds/create-a-build/#prerequisites-5)
...
["EAS Tutorial Series"\\
\\
A course on YouTube: learn how to speed up your development with Expo Application Services.](https://www.youtube.com/playlist?list=PLsXDmrmFV_AS14tZCBin6m9NIS_VCUKe2) ["Async Office Hours: How to make a development build with EAS Build"\\
\\
