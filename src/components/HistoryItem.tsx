    ...
    <Surface style={[styles.container, { backgroundColor: theme.colors.surface }]}>
      <TouchableOpacity onPress={onPress} style={styles.touchable}>
        ...
        <View style={styles.contentContainer}>
          <Text style={[styles.title, { color: theme.colors.onSurface }]} numberOfLines={1} ellipsizeMode="tail">
            {item.title}
          </Text>
          ...
          <View style={styles.metaContainer}>
            ...
            {item.quality && (
              <>
                <Text style={[styles.metaSeparator, { color: theme.colors.onSurface }]}>•</Text>
                <Text style={[styles.metaText, { color: theme.colors.onSurface }]}>
                  {item.quality}
                </Text>
              </>
